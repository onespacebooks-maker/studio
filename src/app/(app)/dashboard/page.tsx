...
const appointments = [
    { doctor: 'Dr. Anjali Sharma', speciality: 'Cardiologist', time: 'Tomorrow, 10:30 AM', hospital: 'Apollo Hospital' },
              ...
              <div className="space-y-4">
                {appointments.map((appt, i) => (
                    <div key={i} className="flex items-center justify-between p-3 bg-secondary/50 rounded-lg">
                        <div>
                            <p className="font-semibold">{appt.doctor} ({appt.speciality})</p>
            ...
            <CardFooter>
              <Button asChild>
                <Link href="/appointments">
                  View All Appointments <motion.div whileHover={{ x: 5 }}><ArrowRight className="ml-2 h-4 w-4" /></motion.div>
                </Link>
              </Button>
            </CardFooter>
          </Card>
